...
if (isset($_POST['submit'])) {
	...
	if(wireless_objectObject::update($updated_mobile)) {
...
$mobile = wireless_objectObject::select_all($_GET['id']);
		...
		<form class='product-add-books' 
			...
			<div>
				...
				<select name='manufacturer'>
					<?php 
						$brands = wireless_objectObject::select_from_table("wireless_product_manufacturer");
			...
			<div>
				...
				<select name='cpu'>
					<?php 
						$cpus = wireless_objectObject::select_from_table("wireless_product_cpu","processor");
						echo "<option value='0'>Unknown</option>";
						foreach ($cpus as $cpu) {
			...
			<div>
				...
				<select name='hdd'>
					<?php 
						$hdds = wireless_objectObject::select_from_table("wireless_product_hdd","internal","external");
						echo "<option value='0'>Unknown</option>";
						foreach ($hdds as $hdd) {
			...
			<div>
				...
				<select name='ram'>
					<?php 
						$rams = wireless_objectObject::select_from_table("wireless_product_ram","capacity");
						echo "<option value='0'>Unknown</option>";
						foreach ($rams as $ram) {
			...
			<div>
				...
				<select name='mornitor'>
					<?php 
						$screens = wireless_objectObject::select_from_table("wireless_product_screen","size","type as screen_type","resolution");
						echo "<option value='0'>Unknown</option>";
			...
			<div>
				...
				<select name='os'>
					<?php 
						$oss = wireless_objectObject::select_from_table("wireless_product_os","name");
						echo "<option value='0'>Unknown</option>";
						foreach ($oss as $os) {
